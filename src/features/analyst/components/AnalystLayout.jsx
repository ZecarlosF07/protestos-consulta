...
const NAV_ITEMS = [
    { label: 'Dashboard', path: ROUTES.ANALYST_DASHBOARD },
    { label: 'Consulta', path: ROUTES.ANALYST_SEARCH },
    { label: 'Historial', path: ROUTES.ANALYST_HISTORY },
]
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right">
                            ...
                            <p className="text-xs text-text-muted">
                                {user?.entidad_financiera?.nombre}
                            </p>
                        </div>
                        <button
                            onClick={signOut}
